...
#define ITERATIONS 1		// Define the number of operations here --Kesara--
...
#define CLOCKS_PER_SEC 10000000		// This is a gussed value. Can change if wanted precisely --Kesara--
// #if USE_CLOCK
