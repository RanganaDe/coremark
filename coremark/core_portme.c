...
#define ITERATIONS 50	// Define the number of operations here --Kesara--   100 iterations 10 secs 
...
#define CLOCKS 10000000		// This is a gussed value. Can change if wanted precisely --Kesara--
#if USE_CLOCK
	#define NSECS_PER_SEC CLOCKS
...
// Timer functions are edited to use the built in timer functions --Kesara--
...
// No need of get_time() function. It is already inside timer.h for pulpino. --Kesara--
