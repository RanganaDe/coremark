...
*/
#ifndef HAS_FLOAT 
#define HAS_FLOAT 0		// No Float in PULPino. Set this to zero. --Kesara--
#endif
...
#define FLAGS_STR ""	// There is no FLAGS_STR. So set this to "". --Kesara--
...
*/
#ifndef SEED_METHOD
#define SEED_METHOD SEED_VOLATILE		// Set this to SEED_VOLATILE cause we are hardcoding the iterations. --Kesara--
#endif
...
*/
#ifndef MEM_METHOD
#define MEM_METHOD MEM_STACK	// set this to MEM_STACK. Malloc is not working. --Kesara--
#endif
...
*/
#ifndef MULTITHREAD
#define MULTITHREAD 1 //default was 1
#endif
