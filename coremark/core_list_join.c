...
ee_u16 core_bench_list(core_results *res, ee_s16 finder_idx) {
	...
	if (finder_idx>0)
		//ee_printf("mergesort\n");
		list=core_list_mergesort(list,cmp_complex,res); //this is where the error occurs in the modelsim trace.-rangana
